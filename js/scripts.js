$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Jack and Rachel's Wedding",

            // Event start date
            start: new Date('Sep 7, 2024 3:30'),
            ...
            end: new Date('Sep 8, 2024 1:00'),

            // Event Address
            address: 'Old Court House, London',

            // Event Description
            description: "We can't wait to see you on our big day. For any queries or issues, please contact name and phone."
        }
    });
